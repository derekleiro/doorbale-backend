...
const TeamSchema = new mongoose_1.Schema({
    ...
    roles: [{ type: String, enum: Object.values(types_1.Role), required: true }],
    ...
    last_login: { type: Date, default: (0, date_fns_tz_1.toZonedTime)(new Date(), "Africa/Nairobi") },
    encrypted_pin: { type: String, required: true },
});
TeamSchema.pre('save', function (next) {
    this.last_login = (0, date_fns_tz_1.toZonedTime)(new Date(), "Africa/Nairobi");
    next();
});
