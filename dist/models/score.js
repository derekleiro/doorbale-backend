...
const ScoreSchema = new mongoose_1.Schema({
    order_id: { type: mongoose_1.Types.ObjectId, required: true, ref: 'Order' },
    customer_id: { type: mongoose_1.Types.ObjectId, required: true, ref: 'Customer' },
...
exports.default = mongoose_1.default.model('TasteScore', ScoreSchema);
